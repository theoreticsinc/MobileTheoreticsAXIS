...
public class MainBTActivity extends Activity implements OnClickListener {
	...
	private void openConn(){
		if (!isConnected) {
			switch (currIndex) {
			case 0: // bluetooth
				myOperation = (IPrinterOperation) new BluetoothOperation(MainBTActivity.this, mHandler);
				break;
			case 1: // wifi
